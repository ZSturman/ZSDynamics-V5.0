  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* SEO */}
        <title>Zachary Sturman | Full-Stack Developer</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Zachary Sturman | Full-Stack Developer"
        />
        <meta
          property="og:description"
          content="Full-stack developer focused on performance, trust, and human-centered AI."
        />
        <meta property="og:url" content="https://zachary-sturman.com" />
        <meta
          property="og:image"
          content="https://zachary-sturman.com/og-image.png"
        />
